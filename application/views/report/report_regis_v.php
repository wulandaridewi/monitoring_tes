...
function searchFile(){
    ...
    if(startDate==""){
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>report/report_regis/getListDoc',
            type: 'POST',
...
function downloadFile(){
    ...
    if(startDate==""){
        ...
        window.location= "<?php echo base_url(); ?>report/report_regis/downloadExcel/?startDate="+startDateID+"&endDate="+endDateID;
