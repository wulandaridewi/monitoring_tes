                ...
                <form class="kt-form" id="form_add" method="post" action="javascript:;">
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="idExpedition" name="expedition" required="">    
                                <option></option>
                                <?php
                                    $data = array();
                                    $data[''] = '';
                                    foreach ($getExpedition as $row) :
                                ?>       
                                    <option value="<?php echo trim($row->expedition_name) ?>"><?php echo trim($row->expedition_name); ?>                                                        
                                    </option>
                                <?php
                                    endforeach;
                                ?>
...
<script type="text/javascript">  
    ...
    var grid;
        grid = t.DataTable({
        responsive: !0,
        ajax: "<?php echo base_url("/download/delivery_external_nondoc/getDevAll"); ?>",
        columns: [
            {data: "no"},
   ...
   $('#getDataBtn').on('click',function(){
    ...
    $("#form_add").submit(function(event){
        ...
        window.location= "<?php echo base_url(); ?>download/delivery_external_nondoc/downloadExcel/?"+dataString;
