...
<script type="text/javascript">  
    ...
    var grid;
        grid = t.DataTable({
        responsive: !0,
        ajax: "<?php echo base_url("/download/delivery_internal_nondoc/getDevAll"); ?>",
        columns: [
            {data: "no"},
    ...
    $("#form_add").submit(function(event){
        ...
        window.location= "<?php echo base_url(); ?>download/delivery_internal_nondoc/downloadExcel/?"+dataString;
