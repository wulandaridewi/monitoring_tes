...
<script type="text/javascript">  
    ...
    var grid;
        grid = t.DataTable({
        responsive: !0,
        ajax: "<?php echo base_url("/download/delivery_external_doc/getDevAll"); ?>",
        columns: [
            {data: "no"},
   ...
   $('#getDataBtn').on('click',function(){
    ...
    $("#form_add").submit(function(event){
        ...
        window.location= "<?php echo base_url(); ?>download/delivery_external_doc/downloadExcel/?"+dataString;
