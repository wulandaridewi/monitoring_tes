				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin">
							<!--begin::Form-->
							<form class="kt-form" action="<?= base_url('update_status/update_deliver_doc/loginUpdateDeliver') ?>" method="post" id="kt_login_form">
		...
		<script>
			 ...
			 $('#kt_login_form').submit(function (e) {
				...
				form.ajaxSubmit({
	                type: "POST",
	            	dataType: "json",
	            	url: "<?= base_url('update_status/update_deliver_doc/loginUpdateDeliver') ?>",
	                success: function (data) {
						...
						var result = data.act;
							if(result == 0){
								...
								//alert('aa');								
								window.location.href = '<?php echo base_url().'' ?>update_status/update_deliver_doc/home/?regNum='+ regNum;
