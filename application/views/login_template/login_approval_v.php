				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin">
							<!--begin::Form-->
							<form class="kt-form" action="<?= base_url('container/my_container/loginApproval') ?>" method="post" id="kt_login_form">
								...
								<div class="form-group">
									...
									<input type="hidden" name="valueUrl" id="valueUrl" value="<?php echo $value; ?>">
		...
		<script>
			 ...
			 $('#kt_login_form').submit(function (e) {
				...
				form.ajaxSubmit({
	                type: "POST",
	            	dataType: "json",
	            	url: "<?= base_url('container/my_container/loginApproval') ?>",
	                success: function (data) {
						...
						var result = data.act;
							if(result == 0){
								...
								//alert('aa');								
								window.location.href = '<?php echo base_url().'' ?>container/my_container/home?detail=2&value='+ valueUrl.replaceAll('+','%2B').replaceAll(' ','%20');
