...
<script type="text/javascript">  
    ...
    var KTDatatablesSearchOptionsColumnSearch = function() {
        ...
        var initTable1 = function() {
            ...
            var table = $('#kt_datatable_2').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo base_url("/update_status/delivery_internal_nondoc/getDevAll"); ?>',
                    type: 'POST',
                    data: {
                        columnsDef: [
                            'no', 'register_doc_id', 'doc_description', 'name', 'department','note', 'recipient', 'information', 'create_date', 'Actions',],
                    },
                },
                columns: [
                    {data: "no"},
                    {data: "register_non_doc_id"},
                ...
                //                    '<i class="fa fa-user-edit" onclick=editUser("'+row.register_non_doc_id+'")></i></a> ';
                //         },
                //     },
                // ],
            });
    ...
    $("#form_add").submit(function(event){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>update_status/delivery_internal_nondoc/uploadExcel",
