            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, row) {
                        var departmentName = row.department.replace(/\s+/g, '%');
                        return '<a class="btn btn-icon btn-light-primary btn-sm mr-2" title="Edit" onclick=view("'+row.dept_id+'","'+departmentName+'")>'+
...
function view(dept_id,deptName){
    ...
    var departmentName = deptName.replaceAll('%', ' '); 
    $('#editDeptID').val(departmentName);
