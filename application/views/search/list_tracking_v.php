<?php 
    ...
    if (empty($getKetDoc)) {
        // echo "string";
        //echo "<center>Register number not found</center>";
        echo"<script language='javascript'>
            UIToastr.init('warning', 'Register Number Not Found'); 
        </script>
        ";
    }
	foreach ($getKetDoc as $key => $value) {
       ...
       //echo $type.'-'.$doc_status.'-'.$register_status.'-'.$status_indexing.'-'.$pickup_by;
        ...
        if($type == 'DOC_IN' && $doc_status == 'DELIVER' && $register_status == 2 && ($status_indexing == 1 || $status_indexing == 2)){
        	echo "<table class='table table-separate table-head-custom table-checkable dataTable no-footer' id='idTabelListDoc' width='100%'>
        		<thead>
        			<tr>        				
		        		<th>No. Register</th>
        ...
        if($type == 'DOC_OUT' && $doc_status == 'DELIVER' && $register_status == 2 && ($status_indexing == 1 || $status_indexing == 2)){
        	echo "<table class='table table-separate table-head-custom table-checkable dataTable no-footer' id='idTabelListDoc' width='100%'>
        		<thead>
        			<tr>        				
		        		<th>No. Register</th>
