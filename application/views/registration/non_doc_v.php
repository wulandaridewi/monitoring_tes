                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="typeRegisDoc" name="typeRegisDoc" required="">
                                    <option value=""></option>
                                    <option value="DOC_IN">Incoming Non Documents</option>
                                    <option value="DOC_OUT">Outgoing Non Documents</option>
                                </select> 
                            </div>
                        </div>
                    </div>   
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio">
                                    <input type="radio" checked="checked" name="radios3" id="locMailroom">
                                    <span></span>Mailroom</label>
                                    <label class="radio">
                                    <input type="radio" name="radios3" id="locOtherRadio">
                                    <span></span>Other</label>
                                </div>
                            </div>
                             <div class="form-group">
                                <input id="locOther" name="locOther" class="form-control" type="text" style="display: none;">  
                            </div> 
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $("input[name=radios3]").focus(function () {
            if (document.getElementById("locOtherRadio").checked == false) {
                // alert('b');
                document.getElementById( 'locOther' ).style.display   = 'block';
       ...
       //alert(type);
        ...
        //alert('dad');
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo base_url(); ?>registration/non_doc/saveNonDocIn",
                data: dataString,
        ...
        //alert('adadda');
         $('#saveDoc').addClass('spinner spinner-white spinner-right');
          ...
          $.ajax({
              type: "POST",
              dataType: "json",
              url: "<?php echo base_url(); ?>registration/non_doc/saveNonDocOut",
              data: dataString,
              success:function(data)
              {
                  if(data.tipePesan == 'success'){
